...
class CityLocationSignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_city_location_signup)
        ...
        autocompleteSupportFragment1.setOnPlaceSelectedListener(object : PlaceSelectionListener {
            ...
            override fun onPlaceSelected(place: Place) {
                ...
                intent.putExtra("plusecode", zipCode)
...
*/
    private fun getCompleteAddress(la: Double, lang: Double): String {
        ...
        try {
            ...
            zipCode = addresses[0].postalCode.toInt()

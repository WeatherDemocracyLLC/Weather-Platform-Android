...
class MetrologistDayAfterTomorrowAdapter(
    private val context: Context,
    private val listModels: ArrayList<DayAfterTomorrowItem>,
    var adapterInterface: AdapterInterface,var vartxt:TextView
) : RecyclerView.Adapter<MetrologistDayAfterTomorrowAdapter.ViewHolder>() {

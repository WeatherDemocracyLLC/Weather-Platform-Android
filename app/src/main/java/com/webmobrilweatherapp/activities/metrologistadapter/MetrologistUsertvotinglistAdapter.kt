...
class MetrologistUsertvotinglistAdapter(
    private val context: Context,
    private val listModel: ArrayList<DataItem>,
    private val listmodels: User?,
    var adapterInterface: AdapterInterface
) : RecyclerView.Adapter<MetrologistUsertvotinglistAdapter.ViewHolder>(), Filterable {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.votername.setText(listModel.get(position).userName)

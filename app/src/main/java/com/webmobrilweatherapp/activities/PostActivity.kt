...
import com.webmobrilweatherapp.databinding.ActivityPostBinding
...
import java.util.*
import com.webmobrilweatherapp.fragment.profile.slideradapter.DoubleClickListener
...
class PostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.videoPlayer.setOnClickListener(object : DoubleClickListener() {
...
//video and Images setUp
                  ...
                  //  binding.txtdates.setText(getDate(it.post!!.createdAt.toString())+" "+getTime(it.post!!.createdAt.toString()))
                    ...
                    getpostUserCommentrecylerview(postId.toString());
    ...
    @RequiresApi(Build.VERSION_CODES.S)
    private fun getpostUserCommentrecylerview(UserPostId: String) {
        ProgressD.showLoading(this, getResources().getString(R.string.logging_in))
            ...
            ?.observe(this) {
                ...
                if (it != null && it.success == true) {
                 //   showBottomSheetDialog()
                    ...
                    binding.recylerviewCommenstuseronpage.layoutManager = layoutManager
                    binding.recylerviewCommenstuseronpage.adapter = usercommentAdapter

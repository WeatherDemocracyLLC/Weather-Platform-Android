...
import com.webmobrilweatherapp.databinding.ActivityInstaHomemetrologistBinding
...
class InstaHomemetrologistActivity : AppCompatActivity() {



    lateinit var binding: ActivityInstaHomemetrologistBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // Toast.makeText(this, "it.data?.followbyRequest.toString()", Toast.LENGTH_LONG).show()
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_insta_homemetrologist)
        val intent = intent
        if (intent != null) {
            type = intent.getIntExtra("type", 1)
            UserIds = intent.getIntExtra("userId", 0)

        }
       // Toast.makeText(this,"${UserIds}",Toast.LENGTH_LONG).show()
       // Log.d("TAG", "1234324567854 ${UserIds}")
        ...
        getuserprofile()
        /* if (type==1){
             binding.imginstahome2.setBackgroundColor(Color.RED)
         }else if(type==0){
             binding.imginstahome2.setBackgroundColor(Color.BLUE)
            ...
            ?.observe(this) {
                ...
                if (it != null && it.success == true) {
                  ...
                  /*  if (it.data.followRequestdata!= null) {
                        requestFromm= it.data.followRequestdata!!

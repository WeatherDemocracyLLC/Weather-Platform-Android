...
import com.webmobrilweatherapp.databinding.ActivityInstaFollowingBinding
import com.webmobrilweatherapp.viewmodel.ApiConstants
import com.google.android.material.bottomsheet.BottomSheetDialog
import com.webmobrilweatherapp.viewmodel.webconfig.ApiConnection.network.AccountViewModel

class InstaFollowingActivity : AppCompatActivity() {
    lateinit var binding: ActivityInstaFollowingBinding
    var clicked = false
    var UserIds = 0
    var eventid = 0
    var points:Int=0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //  Toast.makeText(this, UserIds.toString(), Toast.LENGTH_LONG).show()
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_insta_following)
                    ...
                    else if (it.data.followbyRequest==2)
                    {
                       ...
                       if (followings==false) {
                          // binding.btnfollow.setText("Follow")
                           ...
                           binding.layoutpostInsta.visibility=GONE

...
import com.webmobrilweatherapp.databinding.ActivityChangeEmailMetrologistBinding

class MetrologistChangeEmailActivity : AppCompatActivity() {
    var accountViewModelMetrologist: AccountViewModelMetrologist? = null
    lateinit var binding: ActivityChangeEmailMetrologistBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        accountViewModelMetrologist =
            ViewModelProvider(this).get(AccountViewModelMetrologist::class.java)

        binding = DataBindingUtil.setContentView(this, R.layout.activity_change_email_metrologist)
        ...
        binding.BtnChangeEmailmetrologist.setOnClickListener {
            if (isValidation()) {
                getLoginmetrologist()
            }
        }

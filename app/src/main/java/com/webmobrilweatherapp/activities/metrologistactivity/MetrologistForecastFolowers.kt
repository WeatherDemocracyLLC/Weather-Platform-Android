...
import com.webmobrilweatherapp.activities.metrologistadapter.MetrologistForecastFollowerAdapter
import com.webmobrilweatherapp.adapters.Bottomdialogadapter
import com.webmobrilweatherapp.beans.bottomdialog.DataItem
import com.webmobrilweatherapp.databinding.ActivityMetrologistForecastFolowersBinding
...
/*
var courseModelArrayList: MutableList<FollowerListItem> = java.util.ArrayList<FollowerListItem>()
*/
class MetrologistForecastFolowers : AppCompatActivity(), MetrologistForecastFollowerAdapter.SelectItem {


    lateinit var binding: ActivityMetrologistForecastFolowersBinding
    var accountViewModel: AccountViewModel? = null
    lateinit var metrologistForecastFollowerAdapter: MetrologistForecastFollowerAdapter
    var strdate = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_metrologist_forecast_folowers)
        accountViewModel = ViewModelProvider(this).get(AccountViewModel::class.java)
        binding =
            DataBindingUtil.setContentView(this, R.layout.activity_metrologist_forecast_folowers)
    ...
    private fun filterResult(text: String, productFilterList: MutableList<FollowerListItem>) {
        ...
        //update recyclerview
        //update recyclerview
        metrologistForecastFollowerAdapter.updateList(temp)
        ...
        accountViewModel?.getFollowers("Bearer " + CommonMethod.getInstance(this).getPreference(
            ...
            ?.observe(this) {
                ...
                if (it!!.followerList!!.size>0) {
                    ...
                    binding.totalFollowerss.text = it.followerList?.size.toString() + " Followers"
                    ...
                    metrologistForecastFollowerAdapter = MetrologistForecastFollowerAdapter(this,
                        this,
                        it.followerList as List<FollowerListItem>)
                    val layoutManager =
                        LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
                    binding.MetrologistforecastfollowerRecy.layoutManager = layoutManager
                    binding.MetrologistforecastfollowerRecy.adapter =
                        metrologistForecastFollowerAdapter
                } else {
    ...
    override fun selectItem(id: String) {
        ...
        val btnsheet =
            layoutInflater.inflate(R.layout.metrologist_votefordayy_item, null)
    ...
    private fun getChallengeVote(competitor_id:String,is_temp:String,precipitation_id:String,vote_temp_value:String,vote_date:String,city:String,city_code:String) {
        ...
        accountViewModel?.getChallengevote("Bearer " + CommonMethod.getInstance(this).getPreference(
            AppConstant.KEY_token_Metrologist),competitor_id,is_temp,precipitation_id,vote_temp_value,vote_date,city,city_code)
            ?.observe(this) {
                ProgressD.hideProgressDialog()
                this?.startActivity(Intent(this, MetrologistForecastChallengeActivity::class.java))

...
import com.webmobrilweatherapp.databinding.ActivityWeatherLocationBinding
...
class WeatherLocationActivity : AppCompatActivity() {
    lateinit var binding: ActivityWeatherLocationBinding
    var  latituted:Int=0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        autocompleteSupportFragment1.setOnPlaceSelectedListener(object : PlaceSelectionListener {
            ...
            override fun onPlaceSelected(place: Place) {
                ...
                var intent = Intent(applicationContext,HomeActivity::class.java)
                CommonMethod.getInstance(this@WeatherLocationActivity).savePreference(AppConstant.KEY_LATITITED_CHANAGE_CITY_USER,
                    latitudes!!)
                CommonMethod.getInstance(this@WeatherLocationActivity).savePreference(AppConstant.KEY_LONGITUTED_CHANAGE_CITY_USER,
                    longitudes!!)
                startActivity(intent)
                finish()

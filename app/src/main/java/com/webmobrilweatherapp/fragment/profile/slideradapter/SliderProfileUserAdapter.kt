package com.webmobrilweatherapp.fragment.profile.slideradapter
...
class SliderProfileUserAdapter(private val context: Context) :
    SliderViewAdapter<SliderProfileUserAdapter.VH>() {

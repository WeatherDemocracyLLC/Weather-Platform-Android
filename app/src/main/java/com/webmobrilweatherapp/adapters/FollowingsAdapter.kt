...
class FollowingsAdapter(private val context: Context,val user:Int, private val List: List<FollowingListItem>):
...
/*    interface SelectItem{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FollowingsAdapter.ViewHolder {
        var itemView: View = LayoutInflater.from(context).inflate(R.layout.metrologistsearchprofile,parent,false)
        return  FollowingsAdapter.ViewHolder(itemView)
    }


    override fun onBindViewHolder(holder: FollowingsAdapter.ViewHolder, position: Int)
    {

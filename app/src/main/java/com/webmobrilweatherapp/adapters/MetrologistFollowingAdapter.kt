...
class MetrologistFollowingAdapter(private val context: Context, private val List: List<FollowingListItem>):
    RecyclerView.Adapter<MetrologistFollowingAdapter.ViewHolder>() {
...
/*    interface SelectItem{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MetrologistFollowingAdapter.ViewHolder {
        var itemView: View = LayoutInflater.from(context).inflate(R.layout.metrologistsearchprofile,parent,false)
        return  MetrologistFollowingAdapter.ViewHolder(itemView)
    }


    override fun onBindViewHolder(holder: MetrologistFollowingAdapter.ViewHolder, position: Int)
    {
        ...
        holder.itemView.setOnClickListener {
           ...
           // else if(List.get(position).userType.toString().equals("2"))
            ...
            {                Log.e("thisonefirst","metrologist")

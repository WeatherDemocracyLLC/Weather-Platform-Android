...
class UserSearchprofileAdapter(private val context: Context, private val listModel: ArrayList<Datum>, var adapterInterface: AdapterInterface,
                               var vartxt:TextView
) : RecyclerView.Adapter<UserSearchprofileAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Log.i(TAG, "onBindViewHolder2345675rtfdgv: " + listModel.get(position).city)
        var citys: String = "";

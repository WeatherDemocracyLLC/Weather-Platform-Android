...
public class SearchProfileAdapter extends RecyclerView.Adapter<SearchProfileAdapter.Myviewholder> {
    ...
    public SearchProfileAdapter(Context context, List<SearchProfileModel> profileModelsdata) {
    ...
    @NotNull
    @Override
    public SearchProfileAdapter.Myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.profilesearchrecycle, parent, false);
        return new Myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchProfileAdapter.Myviewholder holder, int position) {

...
class WeatherMayormetrologistAdapter(private val context: Context,private val listmodel: ArrayList<DataItem>, private val listmodel1: Mayor?,var adapterInterface:AdapterInterface
) : RecyclerView.Adapter<WeatherMayormetrologistAdapter.ViewHolder>() ,Filterable{
    ...
    override fun onCreateViewHolder(
        ...
        var itemView: View = LayoutInflater.from(context).inflate(R.layout.weathermayorxml, parent, false)

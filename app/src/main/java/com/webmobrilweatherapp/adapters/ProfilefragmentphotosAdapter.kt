...
class ProfilefragmentphotosAdapter(
    private val context: Context,
    private val ListModel: List<String>,private  val selectItem: ProfilefragmentphotosAdapter.SelectItem
) : RecyclerView.Adapter<ProfilefragmentphotosAdapter.ViewHolder>() {
    lateinit var viewHolder: ViewHolder

    interface SelectItem{
        fun selectItem(imgLink:String)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        var itemView: View =
            LayoutInflater.from(context).inflate(R.layout.profilefragmentphotos, parent, false)

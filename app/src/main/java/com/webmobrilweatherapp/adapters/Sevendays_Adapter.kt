...
class Sevendays_Adapter(private val context: Context, val list: List<DailyForecastsItem>):
    RecyclerView.Adapter<Sevendays_Adapter.ViewHolder>() {

    interface SelectItem{
        fun selectItem(id:String)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Sevendays_Adapter.ViewHolder {

        var itemView: View = LayoutInflater.from(context).inflate(R.layout.sevendays_weather,parent,false)
        return  Sevendays_Adapter.ViewHolder(itemView)


    }


    override fun onBindViewHolder(holder: Sevendays_Adapter.ViewHolder, position: Int) {

...
class challengebyfriend_Adapter(private  val context: Context,private  val selectItem: challengebyfriend_Adapter.SelectItem,private val challengeItem:challengebyfriend_Adapter.ChallengeItem,private  val List:List<com.webmobrilweatherapp.model.challengebyfriends.DataItem>):
    RecyclerView.Adapter<challengebyfriend_Adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): challengebyfriend_Adapter.ViewHolder {
        var itemView: View = LayoutInflater.from(context).inflate(R.layout.challenegebyfriend_item,parent,false)
        return  challengebyfriend_Adapter.ViewHolder(itemView)
    }


    override fun onBindViewHolder(holder: challengebyfriend_Adapter.ViewHolder, position: Int)
    {
